...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      menuItem("Introduction Page", tabName = "introduction_tab", icon = icon("dashboard")),
      menuItem("Weather map Page", tabName = "map_tab", icon = icon("th")),
      menuItem("Hurricane Page", tabName = "hurricane_tab", icon = icon("th")),
      menuItem("Severe Weather Page", tabName = "chart_panel", icon = icon("th")),
    ...
    tabItems(
      ...
      tabItem(tabName = "map_tab",
              ...
              fluidPage(
                ...
                h3("Insight"),
                p("The number of severe natural hazards is generally ", 
                  strong("higher"), 
      ...
      tabItem(tabName = "hurricane_tab",
              ...
              fluidPage(
                includeCSS("final.css"),
                h3("Insight"),
                p("From two charts, we can find out that the ", strong("Pacific hurricane 
                  have more occurrences and longer time span."))
              )
        ),
      
      # Severe weather page
      tabItem(tabName = "chart_panel", 
              sidebarPanel(
      ...
      fluidPage(
        includeCSS("final.css"),
        p("This chart shows the average time span (in minutes) of severe weather 
          in the United States over the period ", strong("2016-2020"), ". It 
          shows 3 severe weather types."),
        h3("Purpose"),
        ...
        h3("Insight"),
        p("The Cold Type had an average time span of nearly ", strong("425 minutes 
        (7 hours)"), "significantly higher than the other two weather types."),
        ...
        p("The average time span for both Fog Type and Storm Type is close to 
          ",strong ("100 minutes."),
